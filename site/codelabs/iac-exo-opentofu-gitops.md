summary: Combining OpenTofu and GitOps (Exoscale SKS Edition)
id: iac-opentofu-gitops
categories: opentofu
tags: MCCE, introduction, iac, fhb-inen
status: Published
authors: Thomas Schuetz

# Combining OpenTofu and GitOps (Exoscale SKS Edition)

<!-- ------------------------ -->

## What You’ll Learn

![Big Picture](img/iac-exo-opentofu-gitops/big-picture.png)
...
![ArgoCD Screen](img/iac-exo-opentofu-gitops/argocd-screen.png)
